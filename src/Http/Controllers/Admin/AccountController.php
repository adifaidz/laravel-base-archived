...
class AccountController extends Controller
{
    ...
    public function show(BaseUser $user)
    {
        ...
        return view('base::admin.account.show',compact('user', 'userJson'));
    }
    ...
    {
        $userJson = json_encode($this->transformer->transform($user));
        return view('base::admin.account.edit',compact('user', 'userJson'))->with($this->getFormReference());
    }
    ...
    public function update(Request $request, BaseUser $user)
    {
        ...
        return redirect()->route('admin.account.show', $user);
    }

    public function changePassword(BaseUser $user){
        return view('base::admin.account.changePassword', compact('user'));
    }
